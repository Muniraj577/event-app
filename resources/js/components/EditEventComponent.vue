        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="updateEvent" ref="eventForm">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mt-2">
                                    <button type="submit" class="btn btn-primary rounded-0">Update
                                    </button>
                                </div>
                            </div>
                        </form>
...
export default {
    ...
    methods: {
        getEvent() {
            this.showLoader();
            axiosInstance.get(`event/edit/${this.$route.params.id}`)
                .then(res => {
        ...
        updateEvent() {
            this.showLoader();
            try {
                axiosInstance.put(`event/${this.$route.params.id}`, this.formData)
                    .then(res => {
